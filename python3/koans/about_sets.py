...
class AboutSets(Koan):
    ...
    def test_empty_sets_have_different_syntax_to_populated_sets(self):
        first_list = [1,2,3]
        second_list = []
        self.assertEqual(set(first_list), {1, 2, 3})
        self.assertEqual(set(second_list), set())
    ...
    def test_creating_sets_using_strings(self):
        test_str = '12345'
        self.assertEqual({test_str}, {'12345'})
        self.assertEqual(set(test_str), set('12345'))

    def test_convert_the_set_into_a_list_to_sort_it(self):
        test_list = ['1', '2', '3', '4', '5']
        self.assertEqual(test_list, sorted(set('12345')))
